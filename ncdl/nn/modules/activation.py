...
import ncdl.nn.functional as F
...
class Threshold(Module):
    r"""Thresholds each element of the input Lattice Tensor.
    ...
    def forward(self, input: Union[Tensor, LatticeTensor]) -> Union[Tensor, LatticeTensor]:
